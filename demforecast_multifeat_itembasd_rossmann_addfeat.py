...
X = X[['Store','Day','Month','DayOfWeek','Open','Promo','StateHoliday','SchoolHoliday']]
...
nf = input('Enter Required no.of features 1-8   \n')
nf = int(nf)
