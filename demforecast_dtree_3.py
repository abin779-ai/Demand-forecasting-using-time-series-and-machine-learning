...
plt.figure()
ax = dff1.plot(label='Observed',color='#006699');
dff2.plot(ax=ax, label='Predicted',title='Xgboost', alpha=.7, color='r',linestyle='--');
...
mse = ((res3) ** 2).mean()
rmse3 = math.sqrt(mse)
print('RMSE for Xgboost is', rmse3)

# Xgboost - adding lag as feature------------------------------------
...
plt.title('xgboost - features added')
...
plt.figure()
ax = dff1.plot(label='Observed',color='#006699');
dff2.plot(ax=ax, label='Predicted',title='Xgboost - features added', alpha=.7, color='r',linestyle='--');
dff3.plot(ax=ax, label='Train data', alpha=.7, color='m',linestyle='--');
ax.set_xlabel('Date');
ax.set_ylabel('Orders');
plt.legend(loc='upper left');
...
mse = ((res4) ** 2).mean()
rmse4 = math.sqrt(mse)
print('RMSE for Xgboost with more features is', rmse4)
...
plt.figure()
ax = dff1.plot(label='Observed',color='#006699');
dff2.plot(ax=ax, label='Predicted',title='Random forest', alpha=.7, color='r',linestyle='--');
dff3.plot(ax=ax, label='Train data', alpha=.7, color='m',linestyle='--');
ax.set_xlabel('Date');
ax.set_ylabel('Orders');
plt.legend(loc='upper left');
...
mse = ((res5) ** 2).mean()
rmse5 = math.sqrt(mse)
print('RMSE for Random forest is', rmse5)
...
plt.plot(t,abs(res3),'m', label='Xgboost')
plt.plot(t,abs(res4),'c', label='Xgboost-more features')
plt.plot(t,abs(res5),'g', label='Decision tree')
plt.xlabel('time')
